...
@Table(name = "\"FrontendApp\"", schema =  "\"school_transport\"")
@Data
...
@Column(name = "\"MetaTags\"")
    ...
    @CollectionTable(schema = "\"school_transport\"", name = "\"FrontendAppMetaTags\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@Column(name = "\"SelectedScreenIds\"")
    @ElementCollection(fetch = FetchType.LAZY)
    @CollectionTable(schema = "\"school_transport\"", name = "\"FrontendAppSelectedScreenIds\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FeScreenId\""), schema = "\"school_transport\"")
